...
public class Main {
    public static void main(String[] args) throws IOException {
        Trainer trainer = new Trainer("trenData", "testData", 0.7);
        userChoice(trainer);
    }
    ...
    private static void displayMenu() {
        ...
        System.out.println("3 Wyswietl macierz omylek");
        ...
        do {
            ...
            switch ((choice = scanner.nextInt())) {
                case 1:
                    ...
                    System.out.println("Zakwalifikowanie wektora: " + trainer.checkVectorFromUser(vectorFromUser));
                    break;
                case 2:
